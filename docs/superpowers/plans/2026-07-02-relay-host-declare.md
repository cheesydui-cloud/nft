...
```sh
    ...
    write_daemon_unit " --connect $panel_url --panel-token-file /etc/nft/panel.token${range_arg}"
```
...
```sh
    ...
    write_daemon_unit " --connect $panel_url --panel-token-file /etc/nft/panel.token${range_arg}${relay_arg}"
```
