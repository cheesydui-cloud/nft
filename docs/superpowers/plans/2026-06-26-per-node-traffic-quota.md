...
Run: `cd /Users/xjetry/work/vibe/nft && go test ./internal/...`
Expected: 全部 PASS
...
Run: `cd /Users/xjetry/work/vibe/nft && go test ./internal/db/ -run 'TestAddUserNodeTraffic|TestResetAllUserTraffic|TestNodeMultipliers|TestCheckAndResetTrafficCycle|TestNodesExceedingQuota' -v`
Expected: FAIL — 函数未定义
...
Run: `cd /Users/xjetry/work/vibe/nft && go test ./internal/server/ -run 'TestApplyCountersMultiplier|TestApplyCountersZeroMultiplier' -v`
Expected: FAIL
...
Run: `cd /Users/xjetry/work/vibe/nft && go test ./internal/... -v`
Expected: 全部 PASS
...
Run: `cd /Users/xjetry/work/vibe/nft && go test ./internal/server/ -run 'TestPerNodeQuotaExclusion|TestChainExcludedWhenOneHopExceedsQuota|TestGlobalQuotaStillDisablesUser' -v`
Expected: FAIL
...
Run: `cd /Users/xjetry/work/vibe/nft && go test ./internal/server/ -run 'TestAPISetNodeMultiplier|TestAPISetPerNodeQuota|TestAPIResetPerNodeTraffic|TestAPIResetTrafficClearsPerNode|TestAPISetResetDays' -v`
Expected: FAIL
...
Run: `grep -rn 'EntryRuleHopIDs' /Users/xjetry/work/vibe/nft/internal/`

如果只在旧的 `applyCounters` 中使用（已移除），则删除该函数。

- [ ] **Step 2: 运行完整测试**

Run: `cd /Users/xjetry/work/vibe/nft && go test ./internal/... -v -count=1`
Expected: 全部 PASS
...
Run: `cd /Users/xjetry/work/vibe/nft && go test ./internal/db/ -run TestOpenDB -v`（或者使用 openDB 的测试，它会触发所有迁移）
